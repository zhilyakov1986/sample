...
export class ContractDynamicControlsPartial {
    Form: IExpandableObject = {
        Archived: new DynamicField(
            this.formGroup,
            'Archived',
            this.contract &&
            this.contract.hasOwnProperty('Archived') &&
            this.contract.Archived !== null
                ? this.contract.Archived
                : false,
            'Archived',
        ...
        CustomerId: new DynamicField(
            ...
            'Customer',
            this.contract &&
            this.contract.hasOwnProperty('CustomerId') &&
        ...
        Number: new DynamicField(
            ...
            'Number',
            this.contract &&
            this.contract.hasOwnProperty('Number') &&
            this.contract.Number !== null
                ? this.contract.Number.toString()
                : '',
            'Number',
        ...
        ServiceDivisionId: new DynamicField(
            ...
            'Service Division',
            this.contract &&
            this.contract.hasOwnProperty('ServiceDivisionId') &&
            this.contract.ServiceDivisionId !== null
                ? this.contract.ServiceDivisionId
                : null,
            'ServiceDivisionId',
            new DynamicFieldType(DynamicFieldTypes.Select, null, null),
        ...
        StatusId: new DynamicField(
            ...
            'Status',
            this.contract &&
            this.contract.hasOwnProperty('StatusId') &&
            this.contract.StatusId !== null
        ...
        UserId: new DynamicField(
            ...
            'User',
            this.contract &&
            this.contract.hasOwnProperty('UserId') &&
            this.contract.UserId !== null
